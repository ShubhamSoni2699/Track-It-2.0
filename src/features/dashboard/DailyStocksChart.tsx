    ...
    <StyledDailyCashChart>
      {!isPendingEquitySummaryDaily && (
        <>
          ...
          >
            <AreaChart data={sortedDailyEquitySummary}>
              <defs>
              ...
              <Area
                dataKey="total_current_amount"
                type="monotone"
                stroke={colors.total_current_amount.stroke}
                fillOpacity={0.4}
                fill={colors.total_current_amount.fill}
                strokeWidth={2}
                name="Net Balance"
                unit="₹"
              />
...
export default DailyStocksChart;
